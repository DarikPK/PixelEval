...
@Composable
fun DiasLaborablesScreen(navController: NavController, viewModel: CuestionarioViewModel) {
    Column(
        ...
        Row {
            ...
            Button(onClick = { navController.navigate(AppRoutes.PRODUCTOS_SERVICIOS) }) {
                Text("Siguiente")
            }
        }
    }
