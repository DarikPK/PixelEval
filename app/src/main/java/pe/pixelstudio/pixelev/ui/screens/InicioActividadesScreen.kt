...
@Composable
fun InicioActividadesScreen(navController: NavController, viewModel: CuestionarioViewModel) {
    Column(
        ...
        Row {
            ...
            Button(onClick = { navController.navigate(AppRoutes.DIRECCION_NEGOCIO) }) {
                Text("Siguiente")
            }
        }
    }
